package com.gmail.ll.ui.components.navigation.bar;
...
import com.gmail.ll.ui.components.navigation.tab.NaviTab;
import com.gmail.ll.ui.components.navigation.tab.NaviTabs;
...
public class AppBar extends FlexBoxLayout {
	...
	private void initAvatar() {
		...
		avatar.setAlt("Menu Usuario");

		ContextMenu contextMenu = new ContextMenu(avatar);
		contextMenu.setOpenOnClick(true);
		contextMenu.addItem("Configuraciones",
				e -> Notification.show("En Construcción.", 3000,
	...
	private void initTabs(NaviTab... tabs) {
		...
		addTab.addClickListener(e -> this.tabs
				.setSelectedTab(addClosableNaviTab("Nueva Pestaña", Home.class)));
