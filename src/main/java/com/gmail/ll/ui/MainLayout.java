...
import com.gmail.ll.ui.components.navigation.bar.TabBar;
import com.gmail.ll.ui.components.navigation.drawer.NaviDrawer;
import com.gmail.ll.ui.components.navigation.drawer.NaviItem;
import com.gmail.ll.ui.components.navigation.drawer.NaviMenu;
import com.gmail.ll.ui.util.UIUtils;
import com.gmail.ll.ui.util.css.Overflow;
import com.gmail.ll.ui.views.Accounts;
import com.gmail.ll.ui.views.Home;
import com.gmail.ll.ui.views.Payments;
import com.gmail.ll.ui.views.Statistics;
import com.gmail.ll.ui.views.personnel.Accountants;
...
@PWA(name = "HETMC", shortName = "HETMC", iconPath = UIUtils.IMG_PATH + "logos/42.png", backgroundColor = "#233348", themeColor = "#233348")
...
public class MainLayout extends FlexBoxLayout
	...
	private void initNaviItems() {
		...
		NaviItem users = menu.addNaviItem(VaadinIcon.USERS, "Usuarios",
				null);
		menu.addNaviItem(users, "Usuarios Permanentes", Accountants.class);
		menu.addNaviItem(users, "Usuarios 	Temporales", Temporal.class);
		menu.addNaviItem(VaadinIcon.USERS, "Grupos", Payments.class);
		menu.addNaviItem(VaadinIcon.DESKTOP, "Aplicaciones", Statistics.class);
